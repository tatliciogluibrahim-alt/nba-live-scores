...
type StampVariant = "filled" | "outline" | "faint" | "onInk" | "filledHeavy";
...
> = {
  ...
  filledHeavy: { background: "var(--ink)", color: "var(--cream)", borderColor: "var(--ink)" },
...
export function Stamp({ text, variant }: { text: string; variant: StampVariant }) {
  ...
  const isHeavy = variant === "filledHeavy";
  return (
    <span
      ...
      style={{
        ...
        fontSize: 10,
        fontWeight: isHeavy ? 800 : 700,
        letterSpacing: "0.1em",
        minWidth: 38,
        padding: isHeavy ? "3px 7px" : "3px 6px",
